...
class AppUtil {
    ...
    object Storage {
        ...
        fun getExternalCacheDir(context: Context): File? {
            ...
            if (file == null) {
                ...
                file = File(Environment.getExternalStorageDirectory().absolutePath + cacheDir)
        ...
        fun getTotalCacheSize(context: Context): String {
            var cacheSize = getDirLength(context.cacheDir)
            if (Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) {
                cacheSize += getDirLength(context.externalCacheDir!!)
            }
            return getFormatFileSize(cacheSize)
        }
    ...
    companion object {
        ...
        fun getAppVersionCode(context: Context): Int {
            ...
            val pm = context.packageManager
            try {
                val packInfo = pm.getPackageInfo(getPackageName(), 0)
